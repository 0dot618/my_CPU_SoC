...
HD_PWD='C:/Users/Administrator/Desktop/proj_single_cycle/proj_single_cycle.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log miniRV_SoC.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source miniRV_SoC.tcl -notrace
