...
HD_PWD='C:/Users/Administrator/Desktop/proj_single_cycle/proj_single_cycle.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log miniRV_SoC.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source miniRV_SoC.tcl
